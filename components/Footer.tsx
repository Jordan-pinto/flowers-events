    ...
    <footer className="bg-charcoal border-t border-gray-900 pt-16 pb-8 px-6 text-center">
      <div className="max-w-4xl mx-auto flex flex-col items-center">
        ...
        <div className="flex items-center gap-8 mb-12">
          ...
          <a href="https://share.google/4AGAKerjHNDhJkH2V" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-gold transition duration-300" title="Laissez-nous un avis sur Google">
